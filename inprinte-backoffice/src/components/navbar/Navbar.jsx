                ...
                <span className="logo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="185.977" height="25.994" viewBox="0 0 185.977 25.994">
                        <g id="title" transform="translate(-286.583 -436.494)">
                            ...
                            <path id="path110096" d="M656.454-63a1.554,1.554,0,0,0-1.522,1.522v22.944a1.554,1.554,0,0,0,1.522,1.522,1.562,1.562,0,0,0,1.559-1.522V-61.478A1.562,1.562,0,0,0,656.454-63Z" transform="translate(-267.524 499.499)" fill="#9b5aad" stroke="#9b5aad" />
                            <path id="path110098" d="M695.674-63.008a1.6,1.6,0,0,0-1.374,1.6v19.417l-9.467-13.551a1.483,1.483,0,0,0-1.225-.668,1.437,1.437,0,0,0-1.151,2.228l11.249,16.113a2.005,2.005,0,0,0,1.634.854,2.028,2.028,0,0,0,2.042-2V-61.485A1.554,1.554,0,0,0,695.674-63.008Zm-17.6,0a1.554,1.554,0,0,0-1.522,1.522v22.944a1.554,1.554,0,0,0,1.522,1.522,1.562,1.562,0,0,0,1.559-1.522V-61.485A1.562,1.562,0,0,0,678.076-63.008Z" transform="translate(-275.07 499.507)" fill="#8a69ba" stroke="#8a69ba" />
                            ...
                            <path id="path110102" d="M785.865-59.918h13.217a1.569,1.569,0,0,0,1.559-1.559A1.562,1.562,0,0,0,799.082-63H785.865a1.554,1.554,0,0,0-1.522,1.522A1.562,1.562,0,0,0,785.865-59.918Zm13.217,19.826H787.424v-8.873h9.653a1.537,1.537,0,0,0,1.559-1.522,1.569,1.569,0,0,0-1.559-1.559H785.865a1.562,1.562,0,0,0-1.522,1.559v11.955a1.554,1.554,0,0,0,1.522,1.522h13.217a1.562,1.562,0,0,0,1.559-1.522A1.569,1.569,0,0,0,799.082-40.093Z" transform="translate(-328.081 499.499)" fill="#6888d5" stroke="#6888d5" />
                        </g>
                    </svg>
                </span>
            </div>
            <div className="navRight">
                <div className="navbarIcons">
                    <div className="navbarIconContainer">
                        {/* put components of icons here */}
                        <div className="icons" id="brightMode">
                            <Brightness2Icon id="bright" onClick={BrightMode} />
                        </div>
                    </div>
                </div>
            </div>
